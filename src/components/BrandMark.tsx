...
const careStages = [
  ...
  { label: 'Early learning', icon: GraduationCap, tone: 'border border-sun/40 bg-sun/30 text-white' },
]

export function BrandMark() {
  return (
    <div className="relative overflow-hidden rounded-[30px] border border-white/35 crm-bg-brand p-6 text-white shadow-soft">
      ...
      <div className="kid-sticker relative z-10 bg-white/20 text-white">
      ...
      <div className="relative z-10 mt-4 overflow-hidden rounded-2xl border border-white/20">
        ...
        />
        <div className="absolute inset-0 crm-bg-brand-overlay" />
      </div>

      <div className="relative z-10 mt-5 flex items-center gap-3">
        <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-white/20 text-xl font-bold shadow-soft">
          B
        </div>
        <span className="kid-ribbon border-white/35 bg-white/20 text-white">
